...
| npm 包 | `release/` 里的 .tgz，也发在仓库右侧 Packages | 本地 release/：tokens 1.2.0-draft.1、ui-react 0.6.0、ui-miniprogram 0.6.0；GitHub Packages 上仍是 tokens 1.1.0-draft.1、ui-react 0.5.5、ui-miniprogram 0.5.0（稳定版） |
