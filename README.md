...
| 入口 | 网址 |
|---|---|
| 规范站（规则、变量、组件库，能直接点） | https://shandiant.github.io/desgin/ |
| 文案与图表规范评审稿（待评审） | https://shandiant.github.io/desgin/评审稿-文案与图表.html |
| 装包给 AI 的提示词 | [模板/同事装包-给AI的提示词.md](模板/同事装包-给AI的提示词.md) |
