...
没有 token、或者还没发布，用文件装：`npm i ./release/shandiant-tokens-1.2.0-draft.1.tgz ./release/shandiant-ui-react-0.6.0.tgz`，小程序是 `./release/shandiant-ui-miniprogram-0.6.0.tgz`。用法见各包的 README 和规范站「组件」章每张卡片的「用法」。
