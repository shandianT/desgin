---
type: packaging
status: 已发布。2026-09-20 三个包第一次发到 GitHub Packages：tokens 1.1.0-draft.1（draft 标签）、ui-react 0.5.2、ui-miniprogram 0.5.0
updated: 2026-09-20
---
...
没有 token、或者还没发布，用文件装：`npm i ./release/shandiant-tokens-1.1.0-draft.1.tgz ./release/shandiant-ui-react-0.5.2.tgz`，小程序是 `./release/shandiant-ui-miniprogram-0.5.0.tgz`。用法见各包的 README 和规范站「组件」章每张卡片的「用法」。
