  ...
  return (
    <div id="basics-howto" className="basics-howto">
      ...
      <div className="states">
        ...
        <State title="Avatar 头像：侧栏账号块、拜访记录的记录人；没有头像就用姓氏"><div className="inline" style={{ alignItems: 'center' }}><Avatar>王</Avatar><Avatar size="large">王</Avatar><Avatar size="small">王</Avatar><Avatar icon={<SbIcon name="customer" />} /><Avatar.Group max={{ count: 3 }}><Avatar>王</Avatar><Avatar>李</Avatar><Avatar>周</Avatar><Avatar>薛</Avatar></Avatar.Group></div></State>
  ...
  return (
    <div id="basics-spare" className="basics-spare">
      ...
      <div className="states">
        ...
        <State title="Upload 上传：拜访附件、合同扫描件；业务里用 SbUpload，它把超限说明和文件结构统一了"><div className="stack"><Upload fileList={files} onChange={({ fileList }) => setFiles(fileList)} beforeUpload={() => false}><Button icon={<SbIcon name="add" />}>点击上传</Button></Upload><Upload.Dragger beforeUpload={() => false} showUploadList={false}><p className="demo-note">拖到这里，或点击选择文件</p></Upload.Dragger></div></State>
