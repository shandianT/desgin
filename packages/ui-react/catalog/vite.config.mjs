...
export default defineConfig({
  ...
  base: './',
  plugins: [react()],
  resolve: { alias: [{ find: /^@shandiant\/tokens\/bridge-antd$/, replacement: resolve(here, '../../tokens/dist/bridge-antd.theme.json') }, { find: /^@shandiant\/tokens\/css$/, replacement: resolve(here, '../../tokens/dist/design-tokens.css') }] },
